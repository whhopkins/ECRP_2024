...
% Anomaly detection to find MC/data differences? Then use this data set to make ML algorithms insensitive to data/MC differences?
...
% a 7% improvement is only 1/sqrt(1.07)~ 3% reduction in  stat uncertainty
...
% Remember, the improvement in efficiency results in a squared or fourth power improvement

% What about changing the calibration method: use radiative Z since you have so much data at the HL-LHC
...
% Resolution really only matters at the trigger no?
% Higgs mass for resolution but won't work on it
% but using the same method
